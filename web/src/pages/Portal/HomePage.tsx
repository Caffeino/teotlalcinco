			...
			<div className='py-1 sm:m-auto max-w-screen-xl'>
				<div className='p-2 rounded-lg'>
					<div className='grid grid-cols-10 gap-4 mb-4'>
						<div className='col-span-8 col-start-2 flex items-center justify-center rounded-sm bg-slate-100 w-full dark:bg-zinc-900/30'>
							<MainLandingCarousel />
						</div>
						<div className='col-start-1 col-end-7 flex items-center justify-center rounded-sm bg-slate-100 h-28 dark:bg-zinc-900/30'></div>
						<div className='col-start-7 col-end-12 flex items-center justify-center rounded-sm bg-slate-100 h-28 dark:bg-zinc-900/30'></div>
					</div>
